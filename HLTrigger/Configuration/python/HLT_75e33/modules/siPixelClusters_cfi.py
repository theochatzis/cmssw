...
siPixelClusters = cms.EDProducer("SiPixelClusterProducer",
    ...
    ElectronPerADCGain = cms.double(1500.0), # Adriano's changes
    MissCalibrate = cms.bool(False),
    Phase2Calibration = cms.bool(True),
    Phase2DigiBaseline = cms.double(1000), # Adriano's changes
    Phase2KinkADC = cms.int32(8),
    Phase2ReadoutMode = cms.int32(3), # Adriano's changes
