...
offlinePrimaryVertices4D = cms.EDProducer("RecoChargedRefCandidatePrimaryVertexSorter",
    assignment = cms.PSet(
    ...
    trackTimeResoTag = cms.InputTag("generalTracksTOFPIDProducer:t0"),
    trackTimeTag = cms.InputTag("generalTracksTOFPIDProducer:sigmat0"),
